...
{
 "use strict";
 var Global,WebSharper,JQuery,Mobile,StandaloneTest,Client,SC$1,List,Operators,UI,Next,Html,attr,T,Arrays,Doc,JavaScript,Pervasives,Elt,AttrProxy,AttrModule,DomUtility,DocElemNode,Unchecked,Attrs,Array,Var,Client$1,Attrs$1,Dyn,SC$2,Docs,Abbrev,Mailbox,View,Docs$1,RunState,NodeSet,An,Snap,Async,Enumerator,SC$3,Fresh,Collections,HashSet,Concurrency,Anims,AppendList,T$1,Seq,SC$4,HashSet$1,SC$5,Scheduler,SC$6,Easing,DomNodes,OperationCanceledException,CancellationTokenSource,HashSetUtil,SC$7,Lazy,IntelliFactory,Runtime;
 Global=window;
 WebSharper=Global.WebSharper=Global.WebSharper||{};
 JQuery=WebSharper.JQuery=WebSharper.JQuery||{};
 Mobile=JQuery.Mobile=JQuery.Mobile||{};
 StandaloneTest=Mobile.StandaloneTest=Mobile.StandaloneTest||{};
 Client=StandaloneTest.Client=StandaloneTest.Client||{};
 SC$1=Global.StartupCode$WebSharper_JQuery_Mobile_StandaloneTest$Client=Global.StartupCode$WebSharper_JQuery_Mobile_StandaloneTest$Client||{};
 ...
 SC$5=Global.StartupCode$WebSharper_UI_Next$Abbrev=Global.StartupCode$WebSharper_UI_Next$Abbrev||{};
 ...
 Client.IndexPage=function()
 {
  var header,a,a$1,a$2,content,a$3,a$4,a$5;
  function generateLink(name)
  {
   var a$6,a$7;
   a$6=[AttrProxy.Create("data-"+"role","button"),AttrModule.Handler("click",function()
   {
    return function()
    {
     return Global.alert(name+" is clicked");
    };
   })];
   a$7=[Doc.TextNode(name)];
   return Doc.Element("a",a$6,a$7);
  }
  header=(a=[AttrProxy.Create("data-"+"role","header")],(a$1=[(a$2=[Doc.TextNode("Main page")],Doc.Element("h1",[],a$2))],Doc.Element("div",a,a$1)));
  content=(a$3=[AttrProxy.Create("data-"+"role","content")],(a$4=[generateLink("Simple Page"),generateLink("Forms"),generateLink("Events")],Doc.Element("div",a$3,a$4)));
  a$5=[AttrProxy.Create("id","mainPage"),AttrProxy.Create("data-"+"role","page"),AttrProxy.Create("data-"+"url","#indexPage")];
  return Doc.Element("div",a$5,[header,content]);
 };
 SC$1.$cctor=Runtime.Cctor(function()
 {
  var indexPage,pages,p,a,m,a$1;
  SC$1.Main=(indexPage=Client.IndexPage(),pages=List.ofArray([indexPage]),p=(a=(m=Global.id,function(l)
  {
   return List.map(m,l);
  }(pages)),Doc.Element("div",[],a)),a$1=p.OnAfterRender(function()
  {
   var a$2,t,element;
   a$2=function(page)
   {
    Global.jQuery(page).page();
   };
   (function(l)
   {
    List.iter(a$2,l);
   }(pages));
   t=(element=p.elt,Global.jQuery(element));
   Global.$.mobile.pageContainer("change",t,null);
